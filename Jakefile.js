...
var servicesFileNoMapRoot = path.join(builtLocalDirectory, "typescriptServicesNoMapRoot.js");
...
compileFile(servicesFileNoMapRoot, servicesSources,[builtLocalDirectory, copyright].concat(servicesSources),
            /*prefixes*/ [copyright],
            /*useBuiltCompiler*/ true,
            ...
            /*callback*/ function () {
                var content = fs.readFileSync(servicesFileNoMapRoot).toString();
                var i = content.lastIndexOf("\n");
                fs.writeFileSync(servicesFileNoMapRoot, content.substring(0, i) + "\r\n//# sourceURL=../built/local/typeScriptServices.js" + content.substring(i));
            });
...
task("runtests-browser", ["tests", "browserify", builtLocalDirectory, servicesFileNoMapRoot], function() {
    cleanTestDirs();
    host = "node"
